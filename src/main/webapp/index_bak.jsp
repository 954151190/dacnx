					...
					<tr>
							...
							<table width="100%">
								<tr >
									<td colspan="2" style="border-bottom:1px solid #e0e0e0;">
										<a href="schemeList.html" title="公司业务">
											<H2>公司业务</H2>
										</a>
									</td>
								</tr>
								<tr>
									<td>
										<table>
											<s:iterator value="schemeCompanyList" var="schemeCompany" status="index">
						...
						<td width="50%">
							<table width="100%">
								<tr>
									<td colspan="2" style="border-bottom:1px solid #e0e0e0;">
										<a href="schemeList.html" title="个人业务">
											<H2>个人业务</H2>
										</a>
									</td>
								</tr>
								<tr>
									<td>
										<table>
											<s:iterator value="schemePersonList" var="schemePerson" status="index">
											<s:if test="#index.odd == true">
											<tr>
												<td>
													<td><a href="toAricle?articleType=SL&scheme.id=${ schemePerson.id }" title="${ schemePerson.title }">${ schemePerson.title }</a></td>
												</td>
											</tr>
											</s:if>
											</s:iterator>			
					...
					<tr>
						<td width="50%">
							<table width="100%">
								<tr>
									<td colspan="2" style="border-bottom:1px solid #e0e0e0;">
										<a href="schemeList.html" title="清算业务">
											<H2>清算业务</H2>
										</a>
									</td>
								</tr>
								<tr>
									<td>
										<table>
											<s:iterator value="schemeClearList" var="schemeClear" status="index">
											<s:if test="#index.odd == true">
											<tr>
												<td>
													<td><a href="toAricle?articleType=SL&scheme.id=${ schemeClear.id }" title="${ schemeClear.title }">${ schemeClear.title }</a></td>
												</td>
											</tr>
											</s:if>
											</s:iterator>			
						...
						<td width="50%">
							<table width="100%">
								<tr>
									<td colspan="2" style="border-bottom:1px solid #e0e0e0;">
										<a href="schemeList.html" title="银行卡">
											<H2>银行卡</H2>
										</a>
									</td>
								</tr>
								<tr>
									<td>
										<table>
											<s:iterator value="schemeCardList" var="schemeCard" status="index">
											<s:if test="#index.odd == true">
											<tr>
												<td>
													<td><a href="toAricle?articleType=SL&scheme.id=${ schemeCard.id }" title="${ schemeCard.title }">${ schemeCard.title }</a></td>
												</td>
											</tr>
											</s:if>
											</s:iterator>			
